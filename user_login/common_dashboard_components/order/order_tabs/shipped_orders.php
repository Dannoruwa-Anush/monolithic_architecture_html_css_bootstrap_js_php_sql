...
define('ORDER_STATUS_SHIPPED', 'shipped'); //constant
$order_status = ORDER_STATUS_SHIPPED;

$searchQuery = isset($_GET['search']) ? trim($_GET['search']) : '';

// Fetch orders
if (!empty($searchQuery)) {
    $shipped_orders = getAllOrdersMatchToSearchKey($mysqli_conn, $order_status, $searchQuery);
    $isSearchMode = true;
} else {
    $pagination = paginate(
        $mysqli_conn,
    ...
    $shipped_orders = $pagination['items'];
